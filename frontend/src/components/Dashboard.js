          ...
          {activities.map((activity, index) => (
            ...
            >
              <Box sx={{ mr: 2 }}>
                ...
                >
                  {activity.type.includes('incident') ? <FolderIcon fontSize="small" /> : <PersonIcon fontSize="small" />}
                </Avatar>
              </Box>
...
function Dashboard() {
  ...
  const stats = [
    ...
    },
    {
      ...
      change: totalPersons > 0 && totalCases > 0 ? `${Math.ceil(totalPersons / totalCases)} avg/incident` : 'No vehicles',
      changeType: 'neutral',
    },
    {
